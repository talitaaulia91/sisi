			...
			<div class="container">
				...
				<div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
					...
					<div class="d-flex align-items-center order-2 order-md-1 gap-2">
						<!--begin::Logo-->
						<a >
							<img alt="Logo" src="{{ assetUrl('assets/img/header/bumn.png') }}" class="h-70px h-md-70px"  />
						</a>
						<a >
							<img alt="Logo" src="{{ assetUrl('assets/img/admin/header/bumn-id.png') }}" class="h-70px h-md-70px" />
						</a>
						<a href="/">
							<img alt="Logo" src="{{ assetUrl('assets/img/admin/header/magenta.png') }}" class="h-70px h-md-70px" />
						</a>
						<a >
							<img alt="Logo" src="{{ assetUrl('assets/img/header/fhci.png') }}" class="h-70px h-md-70px" />
						</a>
						<!--end::Logo image-->
						<!--begin::Logo image-->
						<span
